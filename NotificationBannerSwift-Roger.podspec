...
Pod::Spec.new do |s|
    s.name             = 'NotificationBannerSwift-Roger'
    s.version          = '3.0.5'
...
NotificationBanner is an extremely customizable and lightweight library that makes the task of displaying in app notification banners and drop down alerts an absolute breeze in iOS.
    ...
    s.homepage         = 'https://github.com/MrRogerHuang/NotificationBanner'
    s.license          = { :type => 'MIT', :file => 'LICENSE' }
    s.author           = { 'Roger Huang' => 'roger@beautimode.com' }
    s.source           = { :git => 'https://github.com/MrRogerHuang/NotificationBanner.git', :tag => s.version.to_s }
